...
yay_sound = loadSound("../sound/Children yay! SoundEffect.mp3")
}
...
// i was not sure where to write it so i wrote it here :D
  ...
  gameOver = createSprite(600,290);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(600,320);
...
if (mario.isTouching(checkpointGroup)){
  yay_sound.play();
}
